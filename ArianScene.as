...
private function getPenetratedByArianAndHisHitlerMustache():void {
	...
	if (flags[kFLAGS.ARIAN_VAGINA] > 0)
		...
		if (player.isPregnant()) outputText(images.showImage("arianmale-home-getpenetrated-preg"));
		else outputText(images.showImage("arianmale-home-getpenetrated"));
	...
	if (player.isPregnant())
		outputText("\n\n  \"<i>Are.. are you sure with your current.. conidtion and all..?</i>\"  You wink slyly at him, explaining to [Arian em] that just because you're pregnant doesn't mean you don't still want to get fucked!");
	...
	{ //Only one pole for that hole.
		...
		outputText(".  The lizan doesn't need much encouragement to comply, easily snuggling against you");
		if (!player.isPregnant()) outputText(", breast to breast, ")
		outputText("and sighing softly.  \"<i>I'm sorry.  Sometimes I wonder why you bother doing something like this, with someone like me,</i>\" [Arian ey] says, a hint of sadness in [Arian eir] voice.");
