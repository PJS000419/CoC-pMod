...
//formerly femaleOrGenderless()
		...
		private function kitsunesGenderlessLetHer(willing:Boolean):void
		{
			...
			if (player.isVisiblyPregnant()) outputText(images.showImage("kitsune-fuck-preg"));
			...
			if (player.isVisiblyPregnant()) outputText("heavy, brood-mother belly");
			...
			outputText("The rhythmic thumping of the redhead's hips against your own" + ((player.isVisiblyPregnant()) ? " sloshing your distended abdomen to and fro" : " increases in pace") + ", her tongue hanging out of her mouth lewdly.  Her thick rod spears you again and again, each thrust bringing with it an even more euphoric moan from the horny redhead.  Her sisters groan in unison with her, as though feeding off of her animalistic desire to fuel their own lusts, and as your endurance is stretched to its breaking point, it seems like you'll all cross the line together.\n\n");
			...
			if (player.gender == 2 && player.isVisiblyPregnant()) outputText(" already impregnated ");
...
//formerly stillHungry()
		private function genderlessKitsuneStillHungry(willing:Boolean):void
		{
			clearOutput();
			kitsuneSprite();
			outputText("Just as you are about to slip out of consciousness, you are roused by the feeling of the black-haired kitsune pulling you from her sister's grasp, sliding you" + ((player.isVisiblyPregnant()) ? ", craddling your own pregnant belly," : "") +  "onto your back, and bending low over you.\n\n");
			outputText("\"<i>Still hungry...</i>\" she says softly, rubbing her chubby stomach gently, a quiet rumble issuing forth.\n\n");
			...
			if (flags[kFLAGS.redheadIsFuta] > 0) {
				...
				outputText("Fingers trail delicately across your " + ((player.isVisiblyPregnant()) ? "impregnated tummy, lightly fingering your navel, before tracing up to your " : "") +  "[chest] as the redhead slides in next to you, sparks flying from her fingertips as she encircles your free " + player.nippleDescript(0) + ", eliciting a moan.  Her body presses against yours softly, one leg draping over your " + ((player.isVisiblyPregnant()) ? player.hipDescript() : "waist") + " as she lays her head down and begins to run her tongue along the outer edge, warming you up for her sister.\n\n");
			}
