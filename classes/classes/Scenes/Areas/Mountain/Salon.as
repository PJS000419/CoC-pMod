...
private function gloryholeImp():void {
	...
	if (Math.max(player.cor, player.lib, player.lust) < 33) {
		...
		// 
		outputText("You immediately dive forwards, relishing the idea of taking in another load of demonic cum. Your groin" + ((player.isVisiblyPregnant()) ? " and brood-belly" : "") + " tingles as your lips make their way down the oddly textured shaft, engulphing nearly 10 inches of demon-cock, feeling it press down your throat" + ((player.isVisiblyPregnant()) ? "--you wonder if this could be the cock that delivered the monster spawn into your womb" : "") + ".");
