package classes.Scenes.Camp
{
	...
	public class ImpGang extends Imp
	{
		...
		public function ImpGang()
		{
			...
			this.weaponAttack = 10 + (0.5 * player.statusEffectv1(StatusEffects.BirthedImps));
			...
			this.lust = 30;
			this.lustVuln = .65 - ((0.5 * player.statusEffectv1(StatusEffects.BirthedImps)) / 100);
			this.temperment = TEMPERMENT_LUSTY_GRAPPLES;
			this.level = round(10 + (0.2 * player.statusEffectv1(StatusEffects.BirthedImps)));
			this.gems = rand(15) + 25+ (0.5 * player.statusEffectv1(StatusEffects.BirthedImps));
			this.drop = NO_DROP;
