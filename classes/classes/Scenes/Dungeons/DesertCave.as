	...
	public class DesertCave extends DungeonAbstractContent implements VaginalPregnancy
	{
		...
		*/
		...
		public function doNotResistSavin():void {
			clearOutput();
			outputText("You need her inside you, to be filled with her seed... her children.  To be dominated, to be bred.  You sink into the witch's embrace, letting her slowly, lovingly pump her thick hips into you, taking more and more of her pre-cum and milk into you until you feel bloated, heavy-laden with white witchseed and the food you'll soon be making for your shared offspring.  The cum witch is incredibly gentle, her motions always tender, taking the best of care of you -- loving, in their way -- as she fills you with her cock again and again.  You bask in the fullness of it, going limp from pleasure, content to let her fuck you full of " + (player.isVisiblyPregnant() ? "seed, to feel your pregnant belly slosh and swell yet more" : "little witches, to be the mother of the dunes") + " as you deserve.");
			
			
			if (player.isVisiblyPregnant()){
				outputText(images.showImage("cumwitch-female-fuck-preg"));
				outputText("\n\n\"<i>A good broodmare, beautiful mother.  So strong, so eager.  So willing.  You were made to breed, weren't you?</i>\"  You nod eagerly, punctuated by her thrusting harder, faster into you. \"<i>A broodmare must be sated, even with child.  I will fill your womb,  as I know it aches.... Now take my seed, and make it yours.</i>\"");
				
				outputText("\n\nYou can do nothing more than gasp, milk sputtering from your lips as the first hot spurt of cum pierces your already carrying womb.  The witch rocks her hips, pumping you with load after load of creamy seed, overfilling your brood-swollen mound until thick semen stains your thighs, pouring out around her massive, dominating rod.  The witch seems to go on forever with an infinite reserve of cum inside her, pumping you full of more and more until the dune is snow-white with excess witchseed.  Your pregnant belly now plumped beyond its original size.");
			}
			else{
				outputText(images.showImage("cumwitch-female-fuck"));
