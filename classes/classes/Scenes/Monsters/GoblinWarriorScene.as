package classes.Scenes.Monsters
{
	...
	{
		//public function GoblinWarriorScene(pregnancyProgression:PregnancyProgression, output:GuiOutput){new PlayerGoblinPregnancy(pregnancyProgression, output);}
		...
		public function gobboWarriorBeatYaUp():void {
			...
			//iii. Lust Loss - Female
				...
				if (monster.hasCock()) {
					...
					if (player.isVisiblyPregnant()) outputText(images.showImage("goblin-loss-female-raped-preg"));
