	...
	public class ImpScene extends BaseContent
	{
		...
		*/
		...
		public function impGangabangaEXPLOSIONS(loss:Boolean = false):void {
				...
				if (rand(2) == 0 && (player.cockTotal() > 0 || player.gender == 3)) {
					...
					if (player.hasStatusEffect(StatusEffects.ImpGangBang)) {
						...
						//(Subsequent encounters - High Corruption)
							...
							if (player.isVisiblyPregnant()) outputText(images.showImage("gangbang-loss-human-prologue-preg"));
							else outputText(images.showImage("gangbang-loss-human-prologue"));
					...
					//(If the character has breasts)
					if (player.biggestTitSize() > 0) {
						outputText("Imps lick milk from your " + player.biggestBreastSizeDescript() + " as your rider milks you.  As one imp drinks his fill, staggering away with a sloshing belly, another steps up to guzzle from your milk-spewing udders.\n\n");
			...
			doNext(impGangRapeContinuation);
		}
		
		private function impGangRapeContinuation():void {
			clearOutput();
			...
			doNext(impGangRapeEnd);
		}
		
		private function impGangRapeEnd():void {
			clearOutput();
			...
			outputText("The imp-cock in your throat spasms and its owner rams as deep into you as he can get. He floods your already swollen stomach with inhuman amounts of cum. Again you feel yourself about to black out as the demon pumps jism into you. He pulls out and again you orgasm as you wheeze for air. Another imp forces his cock down your throat as you moan and gasp. Your body shakes in pleasure on the big imp's " + Appearance.cockNoun(CockTypesEnum.DOG) + ".  Tightening his grip on your " + player.hipDescript() + " the master imp howls and slams his shaft into your ");
					...
					outputText(" and he pumps more jism into you than his balls could possibly hold. Your [if (isPregnant = true)pregnant] belly stretches with every blast of cum and you shriek around yet another cock in your throat.\n\n");
					...
					outputText("Your master isn't done with you yet, churning his canine-like knot in your ");
					//(If the player has a vagina)
					if (player.hasVagina()) outputText(player.vaginaDescript(0));
					//(If the player doesn't have a vagina)
					else outputText(player.assholeDescript());
					...
					outputText(". Your toes curl as you feel more pulses of demon-cum work their way up his shaft and into your already-" + ((player.isVisiblyPregnant()) ? "heavily pregnant" : "stuffed") +  " belly.\n\n");				
		...
		private function impLordRapeFemale(overlord:Boolean):void {
			clearOutput();
			if      (doSFWloss())  return;
			if (player.isVisiblyPregnant()) outputText(images.showImage("implord-loss-female-preg"));
			...
			outputText("\n\nYou try to move, but before you can even begin to squirm a hoof presses hard between your " + player.breastDescript(0) + ".  You gasp as the air is temporarily knocked out of your lungs.  The demon chuckles at your last feeble attempt to free yourself.  He holds his " + monster.cockDescript(0) + "" + ((player.isVisiblyPregnant()) ? " against your impregnated mound" : " stroking it lewdly") + ", a cruel smirk stretching across his face.  You watch as several beads of pre begin to drip from his tip onto your stomach.");
			...
			else                   outputText("\n\nThe imp roughly " + ((player.isVisiblyPregnant()) ? "presses your pregnant belly down holding you to the ground and" : "") + " forces his tongue into your [vagina] making you gasp in pleasure.  Your [vagina] clenches around the demonic tongue, squirting some of your girl juices around the wet flesh as it delves deeper into you.  You writhe and squirm trying to fight against the forced pleasure.");
			...
			outputText(", draping his " + monster.cockDescript(0) + ((player.isVisiblyPregnant()) ? " on the bottom of your portruding brood-gut" : " across your wet crotch") + ".  You groan, and unintentionally thrust against the magnificent tool between your legs.  The imp chuckles evilly as you coat his " + monster.cockDescript(0) + " in your girl juice, but he doesn't wait long before he slowly presses his head down against your [vagina].  His head slowly spreads your lips; the pleasure is unmistakable, and forces a loud moan from your lips.");
			...
			outputText("\n\nYou mewl softly as you're viciously fucked by the beast above you " + ((player.isVisiblyPregnant()) ? ", causing your belly and tits to quake with each thrust" : "") + ".  It doesn't take long before your [vagina] clenches tightly around the " + monster.cockDescript(0) + " as you orgasm.  You scream in pleasure as your inner walls begin to milk the imp's " + monster.cockDescript(0) + " of its seed.  The imp quickly succumbs and cums, his swollen balls tightening up against his crotch.  The hot jizz continues to pump into you for what feels like several painfully long minutes, until your " + ((player.isVisiblyPregnant()) ? "already impregnated belly distends further" : "belly bulges slightly") + ", and your " + player.vaginaDescript(0) + " begins to leak the white demonic fluid.");
