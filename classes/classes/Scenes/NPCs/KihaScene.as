...
internal function kihaLossIntro():void {
	...
	else if (player.biggestLactation() >= 2) kihaMilkTitHumiliation();
...
private function kihaRapesLittleGirlsISawItOnTheNews():void {
	...
	if (player.hasItem(consumables.INCUBID)) {
		...
		outputText("When Kiha climaxes, a shuddering, vulnerable moan escapes her careless lips and your own resolve crumbles.  Your " + player.vaginaDescript(0) + " spasms in muscle-clenching ecstasy around her demon dick, milking every drop of geysering jizz pumping into you. White streams erupt from your heavy breasts, showering milk across your wallowing bodies.  Even after the exhilaration of your release fades, the dragon girl continues humping your abused pussy, milking draining her cock and balls for all their worth, until a second, weaker orgasm shudders through your spent flesh.  She has pumped a considerable about of spunk into your guts causing your belly to bulge" + ((player.isVisiblyPregnant()) ? " more than it already was" : "") + ".  Finally, Kiha pulls her cock free from your pussy with a <i>SLURRRP</i> as a gush of spunk seeps from your plumbed hole.  Extracting herself from your lower body, the dragoness stands, still full of spunky energy and taunting reproach.  \"<i>That's what I do to trespassers!  I don't want to see your tight ass around here again without a proper tribute</i>\".");
	...
	outputText("\n\nBy the time you come to, Kiha is long gone.");
