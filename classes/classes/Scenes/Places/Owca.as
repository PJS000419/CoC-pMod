...
public function loseOrSubmitToVapula():void {
	clearOutput();
	if (player.pregnancyIncubation > 0 && player.pregnancyIncubation <= 216) outputText(images.showImage("vapula-inspect-preg"));
	outputText("\n\nVapula taunts you as she circles around you.  \"<i>Look at the slutty pet!  Ain't you a slutty pet?  Yes, you are!  Don't pretend you're not hungry for some fat demon cock, I know you are [if (isPregnant = true), look at that belly you pregnant whore].</i>\"  As she speaks, the crowd gathers closer.  A few creatures show some temerity, giving you pinches and gropes as they near.  The cock-belted imp unties his tentacle; the horror wriggles and squirms as it drops to the ground and slithers toward you.  The tip of the absurdly long pecker inspects your body, pressing itself against your flesh, massaging you in the most sensual places, wetting you with sap-like pre-cum and teasingly grinding itself against your mouth, [if (isPregnant = true) your pregnant belly,] and then your " + player.assholeDescript());
	...
	if (player.isPregnant()){
		outputText(" Your impregnated gut sloshing back and forth with every thrust, you feel filled beyond imagining.");
	}
	//[if cocks]
	if (player.hasCock()) {
...
private function wakeUpAfterDemonGangBangs():void {
	clearOutput();
	if (player.pregnancyIncubation > 0 && player.pregnancyIncubation <= 216) outputText(images.showImage("vapula-aftermath-preg"));
