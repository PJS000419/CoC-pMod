...
public function letKatKnotYourCuntPussyFuck():void {
	//Scene can happen in the streets or at Kath's apartment
	clearOutput();
	if (player.isVisiblyPregnant()) (images.showImage("katherine-fucks-you-knottily-in-the-vagoo-preg"));
...
private function drunkFuck():void {
	...
	if (player.hasCock())
		...
		outputText("All that thrusting " + (player.isVisiblyPregnant() ? "along with the bouncing of your huge belly " : "") + "overcomes you and the walls of your pussy " + (dPen ? "and ass " : "") + "clamp down on Kath’s spear");
